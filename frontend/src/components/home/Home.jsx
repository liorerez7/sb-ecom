      ...
      <section className="px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 tracking-tight" data-testid="home-heading">
              Top Rated Products
            </h2>
          ...
          <div className="relative">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center py-16" data-testid="home-loader">
                <Loader />
                <p className="text-gray-500 mt-4 text-sm font-medium">Loading amazing products...</p>
              </div>
            ) : errorMessage ? (
              <div className="bg-red-50 border border-red-200 rounded-2xl p-8 text-center max-w-md mx-auto" data-testid="home-error">
